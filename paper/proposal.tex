...
\paragraph{Subjects.}
The 13 open-source Java projects of IntentionTest~\cite{qi2025intentiontest} (51--1{,}099 tests each), for comparability, plus one or two active repositories with more than 10{,}000 source files (candidates: Elasticsearch, Apache Flink, Spring Framework), chosen after verifying build feasibility, to address R2. No industrial repository is available to us; this is a stated threat to validity, and developer acceptance is approximated by a three-to-five person review.
